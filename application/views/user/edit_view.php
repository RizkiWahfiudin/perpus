...
<div class="content-wrapper">
  <section class="content-header">
    ...
    <ol class="breadcrumb">
            ...
            <li><a href="<?php echo base_url('user');?>"><i class="fa fa-file-text"></i>&nbsp; Data User</a></li>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" class="form-control" value="<?= $user->anggota_id;?>" name="anggota_id">
                                </div>
                                <div class="form-group">
                                    <label>Tempat Lahir</label>
                                    <input type="text" class="form-control" name="lahir" value="<?= $user->tempat_lahir;?>" required="required" placeholder="Ex : Surabaya">
                                </div>
                                <div class="form-group">
                                    <label>Tanggal Lahir</label>
                                    <input type="date" class="form-control" name="tgl_lahir" value="<?= $user->tgl_lahir;?>" required="required">
                                </div>
                                <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label>Telepon</label>
                                    <input id="uintTextBox" class="form-control" value="<?= $user->telepon;?>" name="telepon" required="required" placeholder="Ex : 0812345678">
                                </div>
                                <div class="form-group">
                                    <label>Email</label>
